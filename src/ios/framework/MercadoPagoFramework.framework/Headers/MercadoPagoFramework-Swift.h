...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MercadoPagoFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20MercadoPagoFramework11AppDelegate")
...
SWIFT_CLASS("_TtC20MercadoPagoFramework6HomeVC")
...
SWIFT_CLASS("_TtC20MercadoPagoFramework16HueMercadoPagoVC")
@interface HueMercadoPagoVC : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC20MercadoPagoFramework13SceneDelegate")
...
@interface UIViewController (SWIFT_EXTENSION(MercadoPagoFramework)) <PXLifeCycleProtocol>
...
SWIFT_CLASS("_TtC20MercadoPagoFramework14ViewController")
@interface ViewController : UIViewController
- (IBAction)btnPagar:(UIButton * _Nonnull)sender;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
